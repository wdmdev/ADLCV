...
class Diffusion:
    ...
    def q_sample(self, x, t):
        ...
        """
        # My implementation of the forward process below
    ...
    def p_mean_std(self, model, x_t, t):
        ...
        # My Implementation of the revese process
    ...
    def p_sample(self, model, x_t, t):
        ...
        noise = torch.randn_like(x_t) if t[0] > 1 else torch.zeros_like(x_t) # Sample noise from a normal distribution in shape of x_t
